One problem a day. This repo will contains the answers. I'm timing only the first solve
...
[Java](https://github.com/kinshuk4/algorithms-java/blob/master/src/main/java/com/vaani/dsa/algo/array/ArrayProductExceptSelf.java)
