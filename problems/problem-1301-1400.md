# Daily Coding Problems 1301 - 1400

## Daily Coding Problem 1301 [Medium]
...
## Daily Coding Problem 1302 [Hard]
...
## Daily Coding Problem 1303 [Medium]

This problem was asked by Facebook.

Given an integer n, find the next biggest integer with the same number of 1-bits on. For example, given the number 6 (`0110` in binary), return 9 (`1001`).

## Daily Coding Problem 1304 [Medium]

This question was asked by Google.

Given an integer `n` and a list of integers `l`, write a function that randomly generates a number from `0` to `n-1` that isn't in `l` (uniform).

## Daily Coding Problem 1305 [Hard]

This problem was asked by YouTube.

Write a program that computes the length of the longest common subsequence of three given strings. For example, given "epidemiologist", "refrigeration", and "supercalifragilisticexpialodocious", it should return `5`, since the longest common subsequence is "eieio".

## Daily Coding Problem 1306 [Hard]
...
## Daily Coding Problem 1307 [Medium]
...
## Daily Coding Problem 1308 [Medium]
...
## Daily Coding Problem 1309 [Hard]
...
## Daily Coding Problem 1310 [Medium]

This problem was asked by Fitbit.

Given a linked list, rearrange the node values such that they appear in alternating `low -> high -> low -> high ...` form. For example, given `1 -> 2 -> 3 -> 4 -> 5`, you should return `1 -> 3 -> 2 -> 5 -> 4`.

## Daily Coding Problem 1311 [Hard]
...
## Daily Coding Problem 1312 [Easy]

This problem was asked by Two Sigma.

Using a function `rand5()` that returns an integer from 1 to 5 (inclusive) with uniform probability, implement a function `rand7()` that returns an integer from 1 to 7 (inclusive).

## Daily Coding Problem 1313 [Medium]

This problem was asked by Yahoo.

Write a function that returns the bitwise AND of all integers between `M` and `N`, inclusive.

## Daily Coding Problem 1314 [Easy]
...
## Daily Coding Problem 1315 [Medium]
...
## Daily Coding Problem 1316 [Hard]
...
## Daily Coding Problem 1317 [Medium]

This problem was asked by Pinterest.

The sequence `[0, 1, ..., N]` has been jumbled, and the only clue you have for its order is an array representing whether each number is larger or smaller than the last. Given this information, reconstruct an array that is consistent with it. For example, given `[None, +, +, -, +]`, you could return `[1, 2, 3, 0, 4]`.

## Daily Coding Problem 1318 [Easy]
...
## Daily Coding Problem 1319 [Medium]

Given a real number `n`, find the square root of n. For example, given `n = 9`, return `3`.

## Daily Coding Problem 1320 [Hard]
...
## Daily Coding Problem 1321 [Medium]
...
## Daily Coding Problem 1322 [Hard]
...
## Daily Coding Problem 1323 [Hard]
...
## Daily Coding Problem 1324 [Hard]
...
## Daily Coding Problem 1325 [Hard]

This problem was asked by Etsy.

Given a sorted array, convert it into a height-balanced binary search tree.

## Daily Coding Problem 1326 [Medium]
...
## Daily Coding Problem 1327 [Hard]
...
## Daily Coding Problem 1328 [Hard]
...
## Daily Coding Problem 1329 [Easy]
...
## Daily Coding Problem 1330 [Easy]
...
## Daily Coding Problem 1331 [Easy]
...
## Daily Coding Problem 1332 [Hard]
...
## Daily Coding Problem 1333 [Medium]
...
## Daily Coding Problem 1334 [Easy]
...
## Daily Coding Problem 1335 [Medium]
...
## Daily Coding Problem 1336 [Hard]

This problem was asked by Microsoft.

You have an N by N board. Write a function that, given N, returns the number of possible arrangements of the board where N queens can be placed on the board without threatening each other, i.e. no two queens share the same row, column, or diagonal.

## Daily Coding Problem 1337 [Easy]
...
## Daily Coding Problem 1338 [Medium]
...
## Daily Coding Problem 1339 [Medium]
...
## Daily Coding Problem 1340 [Medium]
...
## Daily Coding Problem 1341 [Easy]

This problem was asked by PayPal.

Given a binary tree, determine whether or not it is height-balanced. A height-balanced binary tree can be defined as one in which the heights of the two subtrees of any node never differ by more than one.

## Daily Coding Problem 1342 [Easy]
...
## Daily Coding Problem 1343 [Hard]
...
## Daily Coding Problem 1344 [Hard]
...
## Daily Coding Problem 1345 [Easy]

This problem was asked by WhatsApp.

Given an array of integers out of order, determine the bounds of the smallest window that must be sorted in order for the entire array to be sorted. For example, given `[3, 7, 5, 6, 9]`, you should return `(1, 3)`.

## Daily Coding Problem 1346 [Medium]
...
## Daily Coding Problem 1347 [Easy]
...
## Daily Coding Problem 1348 [Hard]
...
## Daily Coding Problem 1349 [Medium]
...
## Daily Coding Problem 1350 [Easy]
...
## Daily Coding Problem 1351 [Hard]

This problem was asked by Facebook.

Given an array of numbers of length `N`, find both the minimum and maximum using less than `2 * (N - 2)` comparisons.

## Daily Coding Problem 1352 [Hard]
...
## Daily Coding Problem 1353 [Medium]
...
## Daily Coding Problem 1354 [Medium]
...
## Daily Coding Problem 1355 [Easy]
...
## Daily Coding Problem 1356 [Easy]
...
## Daily Coding Problem 1357 [Hard]
...
## Daily Coding Problem 1358 [Medium]
...
## Daily Coding Problem 1359 [Medium]

This problem was asked by Facebook.

Given a stream of elements too large to store in memory, pick a random element from the stream with uniform probability.

## Daily Coding Problem 1360 [Medium]
...
## Daily Coding Problem 1361 [Hard]
...
## Daily Coding Problem 1362 [Easy]
...
## Daily Coding Problem 1363 [Easy]
...
## Daily Coding Problem 1364 [Hard]
...
## Daily Coding Problem 1365 [Easy]

This problem was asked by Amazon.

Given a complete binary tree, count the number of nodes in faster than O(n) time. Recall that a complete binary tree has every level filled except the last, and the nodes in the last level are filled starting from the left.

## Daily Coding Problem 1366 [Medium]

This problem was asked by Dropbox.

Given an undirected graph G, check whether it is bipartite. Recall that a graph is bipartite if its vertices can be divided into two independent sets, U and V, such that no edge connects vertices of the same set.

## Daily Coding Problem 1367 [Medium]
...
## Daily Coding Problem 1368 [Hard]

This problem was asked by Twitch.

Describe what happens when you type a URL into your browser and press Enter.

## Daily Coding Problem 1369 [Medium]
...
## Daily Coding Problem 1370 [Hard]
...
## Daily Coding Problem 1371 [Easy]
...
## Daily Coding Problem 1372 [Easy]
...
## Daily Coding Problem 1373 [Medium]
...
## Daily Coding Problem 1374 [Medium]
...
## Daily Coding Problem 1375 [Medium]
...
## Daily Coding Problem 1376 [Hard]

This problem was asked by Apple.

Given a linked list, uniformly shuffle the nodes. What if we want to prioritize space over time?

## Daily Coding Problem 1377 [Hard]
...
## Daily Coding Problem 1378 [Easy]

This problem was asked by Google.

Given a binary tree of integers, find the maximum path sum between two nodes. The path must go through at least one node, and does not need to go through the root.

## Daily Coding Problem 1379 [Hard]

This problem was asked by Nvidia.

Find the maximum of two numbers without using any if-else statements, branching, or direct comparisons.

## Daily Coding Problem 1380 [Hard]
...
## Daily Coding Problem 1381 [Medium]
...
## Daily Coding Problem 1382 [Medium]

This problem was asked by Facebook.

Describe an algorithm to compute the longest increasing subsequence of an array of numbers in `O(n log n)` time.

## Daily Coding Problem 1383 [Medium]
...
## Daily Coding Problem 1384 [Easy]
...
## Daily Coding Problem 1385 [Easy]
...
## Daily Coding Problem 1386 [Medium]

This problem was asked by Dropbox.

Given the root to a binary search tree, find the second largest node in the tree.

## Daily Coding Problem 1387 [Easy]
...
## Daily Coding Problem 1388 [Medium]

This problem was asked by Apple.

Implement a queue using two stacks. Recall that a queue is a FIFO (first-in, first-out) data structure with the following methods: `enqueue`, which inserts an element into the queue, and `dequeue`, which removes it.

## Daily Coding Problem 1389 [Medium]
...
## Daily Coding Problem 1390 [Medium]
...
## Daily Coding Problem 1391 [Medium]
...
## Daily Coding Problem 1392 [Hard]
...
## Daily Coding Problem 1393 [Easy]
...
## Daily Coding Problem 1394 [Easy]

This problem was asked by Google.

Given the head of a singly linked list, reverse it in-place.

## Daily Coding Problem 1395 [Hard]
...
## Daily Coding Problem 1396 [Hard]
...
## Daily Coding Problem 1397 [Easy]
...
## Daily Coding Problem 1398 [Medium]
...
## Daily Coding Problem 1399 [Medium]
...
## Daily Coding Problem 1400 [Medium]
